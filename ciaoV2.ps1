...
$SMTPInfo.Credentials = New-Object System.Net.NetworkCredential('nimazarei091@gmail.com', 'Nima135689') #Email with which you want to send information
$ReportEmail = New-Object System.Net.Mail.MailMessage
$ReportEmail.From = 'nimazarei091@gmail.com' #Email in which you want to receice the information
$ReportEmail.To.Add('nimazarei091@gmail.com') #Email in which you want to receive the information
